...
test_patterns = [
	...
	url(r'^push-me', views.stk_push_success, name='test_stk_push_success'),
...
urlpatterns = [
	...
	url(r'^push-me/', views.stk_push_success, name='push_me'),
	url('live/', views.stk_push_success, name='push_me'),
